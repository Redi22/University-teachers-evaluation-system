...
public class TeacherEvaluationView {
    public StackPane teacherEvaluationView(){
         ...
         try {
                ...
                serv2 = (DatabaseServiceInterface) Naming.lookup("rmi://localhost:5050/getDoneTeacherTasks");
                List<Task> doneTasks = serv2.getDoneTeacherTasks(UniversityTeachersEvaluation.currentUser.getUser().getTeacherId()); 
                System.err.println(UniversityTeachersEvaluation.currentUser.getUser().getTeacherId());
        ...
        //comparing and assigning the evaluations by the 3 categories
            evals.forEach(e -> 
                {
                    if(e.getValue() <= 30){
